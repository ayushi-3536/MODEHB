...
file = open('C:\\Users\\ayush\\OneDrive\\Documents\\courses\\automl\\project\\multiobj\\multi-obj-baselines\\moahbanana_backup\\MOSHBANANAS1637152572.4292984.pickle', 'rb')
...
cost3=bd3
import numpy as np
file_name = open('C:\\Users\\ayush\\OneDrive\\Documents\\courses\\automl\\project\\multiobj\\multi-obj-baselines\\moahbanana_backup\\' + 'moshbanana_1_every_run_cost.txt', 'w')
                # for line in costs:
np.savetxt(file_name, cost3)
file_name = open('C:\\Users\\ayush\\OneDrive\\Documents\\courses\\automl\\project\\multiobj\\multi-obj-baselines\\moahbanana_backup\\' + 'cost_msehvi_1_every_run_cost.txt', 'w')
                # for line in costs:
