...
def input_arguments():
    ...
    parser.add_argument('--runtime', type=int, default=24*3600,
                        help='total runtime')
...
experiment = get_fashion('MODEHB_Fashion_{}_{}_{}_mib_{}_mab_{}'.format(args.seed,args.mo_strategy,
...
def objective_function(cfg, budget, run=1, **kwargs):
    global num_evals
    ...
    params['n_conv_l'] = cfg['n_conv_l']
    params['n_fc_l'] = cfg['n_fc_l']
    params['n_conv_0'] = cfg['n_conv_0'] if 'n_conv_0' in cfg.keys() else 16
    params['n_conv_1'] = cfg['n_conv_1'] if 'n_conv_1' in cfg.keys() else 16
    params['n_conv_2'] = cfg['n_conv_2'] if 'n_conv_2' in cfg.keys() else 16
    #
    ...
    #
    params['kernel_size'] = cfg['kernel_size']
    params['lr_init'] = cfg['lr_init']
