...
class BANANAS:
    ...
    def __init__(self,neural_predictor,
                 ...
                 eta,
                 select_models,
                 function_evaluations,max_time, mutation_type = Mutation.GAUSSIAN):
        logger.info("initializing moshbaanan")
        ...
        logger.info("mutation type is :{}",mutation_type)
