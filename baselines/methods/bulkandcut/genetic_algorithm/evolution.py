...
class Evolution:
    ...
    def run(self, time_budget: float, budget_split: tuple = (.35, .40, .25)):
        ...
        try:
            ...
            logger.info("inside bulk and cut")
            ...
            logger.info("Starting phase 1: Initiate population")
            ...
            while True:
                ...
                if remaining < 0:
                    break
                logger.info(f"Still {remaining / 60.:.1f} minutes left for the initial phase")
                self._train_naive_individual()


            # Phase 2: Bulk-up
            logger.info("Starting phase 2: Bulk-up")
            ...
            while True:
                ...
                if remaining < 0:
                    break
                logger.info(f"Still {remaining / 60.:.1f} minutes left for the bulk-up phase")
            ...
            while True:
                ...
                if remaining < 0:
                    break
                logger.info(f"Still {remaining / 60.:.1f} minutes left for the slim-down phase")
            ...
            save_experiment(self.experiment, f'{self.experiment.name}.pickle')
